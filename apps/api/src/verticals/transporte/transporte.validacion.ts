...
import { DatosEntregaViajeDto, SolicitudViaje, SolicitudViajeDto } from 'shared';
 ...
 */
export async function solicitudValida(bruta: unknown): Promise<SolicitudViaje | null> {
  if (!bruta || typeof bruta !== 'object') return null;
  const dto = plainToInstance(SolicitudViajeDto, bruta);
