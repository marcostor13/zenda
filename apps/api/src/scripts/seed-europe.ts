...
async function seed(): Promise<void> {
  ...
  await db.collection('servicios').insertMany([
    baseServicio({
      ...
      ubicacion: { ciudad: 'Madrid', geo: { type: 'Point', coordinates: [-3.6873, 40.4148] } },
    ...
    baseServicio({
      ...
      imagenes: img.alojamiento,
      ubicacion: { ciudad: 'Barcelona', geo: { type: 'Point', coordinates: [2.1540, 41.3915] } },
      ...
      politicaCancelacion: 'Cancelación gratuita hasta 24 horas antes del ingreso.',
      requisitoVacunas: true, paseosIncluidos: true, camaras24h: true,
    ...
    baseServicio({
      ...
      imagenes: img.alojamiento,
      ubicacion: { ciudad: 'Lisboa', geo: { type: 'Point', coordinates: [-9.1370, 38.7462] } },
      ...
      checkIn: '12:00', checkOut: '11:00',
      politicaCancelacion: 'Cancelación gratuita hasta 72 horas antes del ingreso.',
  ...
  await db.collection('servicios').insertMany([
    baseServicio({
      ...
      barrio: 'Eixample', direccion: 'Gran Via de les Corts Catalanes 600, 08007 Barcelona',
    ...
    baseServicio({
      ...
      barrio: 'El Prat', direccion: 'Aeropuerto Josep Tarradellas T1, 08820 El Prat de Llobregat',
  ...
  await db.collection('servicios').insertMany([
    baseServicio({
      ...
      barrio: 'Chamberí', direccion: 'Calle de Santa Engracia 108, 28003 Madrid',
    ...
    baseServicio({
      ...
      barrio: 'XV Distrito', direccion: 'Rue de la Convention 120, 75015 París',
    ...
    baseServicio({
      ...
      imagenes: [img.veterinaria],
      ubicacion: { ciudad: 'Valencia', geo: { type: 'Point', coordinates: [-0.3722, 39.4623] } },
      barrio: 'Russafa', direccion: 'Carrer de Sueca 45, 46006 Valencia',
  ...
  await db.collection('servicios').insertMany([
    baseServicio({
      ...
      barrio: 'Salamanca', direccion: 'Calle de Alcalá 130, 28009 Madrid',
    ...
    baseServicio({
      ...
      barrio: 'Estrela', direccion: 'Rua de São Bento 200, 1250-219 Lisboa',
  ...
  await db.collection('servicios').insertMany([
    baseServicio({
      ...
      barrio: 'Casa de Campo', direccion: 'Paseo del Embarcadero 12, 28011 Madrid',
    ...
    baseServicio({
      ...
      barrio: 'XI Distrito', direccion: 'Rue du Faubourg du Temple 90, 75011 París',
