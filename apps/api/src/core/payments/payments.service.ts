...
import { PagoEstado, PaymentIntentResponseDto, IVA_RATE, VerticalKey } from 'shared';
...
export class PaymentsService {
  ...
  calcularDesglose(reserva: ReservaDocument): Promise<DesglosePago> {
    return this.calcularDesgloseDesdeSubtotal(reserva.montoSubtotal, reserva.vertical);
  }
